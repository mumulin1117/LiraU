...
@interface LirauVirtualCurrencyLorauaWalletView ()
...
@implementation LirauVirtualCurrencyLorauaWalletView
...
- (void)configureWithGlobalCitizenLorauaProfile:(LirauGlobalCitizenLorauaProfile *)profile {
    NSString *balance = [self normalizedBalanceText:profile.virtualCurrencyLorauaBalance];
