...
@interface LirauLanguageExchangePartnerLorauaChipView ()
...
@implementation LirauLanguageExchangePartnerLorauaChipView
...
- (void)configureWithTandemLearningLorauaRecommendation:(LirauTandemLearningLorauaRecommendation *)recommendation {
    self.nameLabel.text = recommendation.nativeSpeakerLorauaName;
    self.currentAvatarURLString = recommendation.avatarChatLorauaURLString ?: @"";
