...
final class LirauProfileSetupViewController: UIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
    ...
    private func setupLayout() {
        ...
        avatarButton.backgroundColor = LirauTheme.card
