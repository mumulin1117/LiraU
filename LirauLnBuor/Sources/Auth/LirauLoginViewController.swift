...
final class LirauLoginViewController: UIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
    ...
    private func setupLayout() {
        ...
        let agreementButton = LirauAgreementButton()
    ...
    @objc private func toggleAgreement(_ sender: LirauAgreementButton) {
