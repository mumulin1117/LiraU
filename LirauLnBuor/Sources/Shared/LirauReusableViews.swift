...
final class LirauPrimaryButton: UIButton {
    ...
    init(title: String) {
        ...
        titleLabel?.font = LirauTheme.buttonFont()
        ...
        if let image = UIImage(named: "lira_auth_primary_button_bg") {
            ...
            gradientLayer.colors = [LirauTheme.primary.cgColor, LirauTheme.primaryEnd.cgColor]
...
final class LirauTextField: UITextField {
    init(placeholder: String, isSecure: Bool = false, iconName: String? = nil) {
        ...
        borderStyle = .none
        font = LirauTheme.bodyFont(14)
        textColor = .white
        tintColor = .white
        backgroundColor = LirauTheme.authField
        layer.cornerRadius = 18
...
final class LirauInfoCardView: UIView {
    private let titleLabel = UILabel()
    private let bodyLabel = UILabel()

    init(title: String, body: String) {
        super.init(frame: .zero)
        backgroundColor = LirauTheme.card
        layer.cornerRadius = 18
        layer.borderWidth = 1
        layer.borderColor = LirauTheme.border.cgColor

        titleLabel.text = title
        titleLabel.font = .systemFont(ofSize: 17, weight: .semibold)
        titleLabel.textColor = LirauTheme.text
        titleLabel.numberOfLines = 0

        bodyLabel.text = body
        bodyLabel.font = LirauTheme.bodyFont(14)
        bodyLabel.textColor = LirauTheme.secondaryText
...
extension UIViewController {
    func lirauShowAlert(title: String, message: String) {
...
final class LirauAuthBackdropView: UIView {
...
final class LirauAgreementButton: UIButton {
    ...
    init() {
        ...
        setTitleColor(LirauTheme.mutedText, for: .normal)
