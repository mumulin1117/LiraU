...
final class LirauCommunityViewController: UIViewController {
    ...
    @objc private func openAIMentor() {
        let controller = LirauWebPortalViewController(entryURLString: LirauWebRoute.languageAIMentorPath())
        controller.hidesBottomBarWhenPushed = true
        navigationController?.pushViewController(controller, animated: true)
    }
