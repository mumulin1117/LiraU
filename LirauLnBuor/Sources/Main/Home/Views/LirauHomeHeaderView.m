...
@implementation LirauHomeHeaderView
...
- (void)buildView {
    ...
    [_notificationButton addTarget:self action:@selector(didTapNotification) forControlEvents:UIControlEventTouchUpInside];
